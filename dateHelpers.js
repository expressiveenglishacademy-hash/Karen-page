...
(function registerDateHelpers(app) {
  ...
  app.parseLocalDate = parseLocalDate;
  app.startOfDay = startOfDay;
  app.toISODate = toISODate;
  app.addDays = addDays;
  app.subtractDays = subtractDays;
  app.getInternalReminderDate = getInternalReminderDate;
  app.formatDate = formatDate;
  app.formatDateTime = formatDateTime;
  app.isSameDay = isSameDay;
  app.isBeforeDay = isBeforeDay;
  app.getCaseDisplayStatus = getCaseDisplayStatus;
  app.getDashboardBucket = getDashboardBucket;
})(window.KARENApp);
