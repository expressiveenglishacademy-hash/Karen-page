...
(function registerApp(app) {
  ...
  const getCaseDisplayStatus = app.helpers.getCaseDisplayStatus;
  const getDashboardBucket = app.helpers.getDashboardBucket;
  const toISODate = app.helpers.toISODate;
  ...
  function buildHistoryEntry(text, createdAt) {
    const rawValue = createdAt || new Date();
    const timestamp = rawValue instanceof Date ? rawValue : new Date(rawValue);
